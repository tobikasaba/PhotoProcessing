...
class Image:
    ...
    def __init__(self, x_pixels=0, y_pixels=0, num_channels=0, filename=''):
        ...
        if x_pixels and y_pixels and num_channels:
            ...
            # x_pixels represents the total number of arrays in the matrix
            # y_pixels represents the number of rows in each list array in the matrix
            # num_channels represents the number of rows in each array of the matrix
